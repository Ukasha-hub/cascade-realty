    ...
    return (
        <div className="" >
           ...
           <div className="bg-slate-700/75 flex flex-col  gap-5 mb-5 py-10 lg:mx-[20vw]  border-y-2">
            <h1 className="flex justify-center font-bold text-5xl animate__animated animate__bounce">Welcome Back</h1>
             <p className="flex justify-center text text-gray-400 animate__animated animate__bounce">Enter to get unlimited access to data and information</p>
