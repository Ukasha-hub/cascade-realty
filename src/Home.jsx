    ...
    return (
        <div>
            ...
            <>
                ...
                >
                    <SwiperSlide >
                      <div className='absolute m-5 flex flex-col  left-[2vw] text-black font-semibold lg:gap-5  z-10 text-xl p-5 rounded-lg  bg-slate-100/75'><h1 className='text-gray-500 lg:text-3xl '>Time to meet your</h1><h1 className='lg:text-7xl font-extrabold animate__animated animate__bounce'>NEW SWEET HOME</h1></div>  
                    ...
                    <SwiperSlide>
                    <div className='absolute m-5 flex flex-col  left-[2vw] text-black font-semibold lg:gap-5  z-10 text-xl p-5 rounded-lg  bg-slate-100/75'><h1 className='lg:text-7xl font-extrabold animate__animated animate__bounce'>TOMMOROW, BUILD TODAY</h1><h1 className='text-gray-500 lg:text-3xl'>We are the investors, asset manager and builder of asset teams</h1></div>
                    ...
                    <SwiperSlide>
                    <div className='absolute m-5 flex flex-col left-[2vw] text-black font-semibold lg:gap-5  z-10 text-xl p-5 rounded-lg  bg-slate-100/75'><h1 className='lg:text-7xl font-extrabold animate__animated animate__bounce'>MODERN LIVING FOR EVERYONE</h1><h1 className='text-gray-500 lg:text-3xl'>We provide a complete service for the purchase or rental of real estate.</h1></div>
